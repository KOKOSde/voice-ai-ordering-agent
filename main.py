...
from utils.tts import get_audio_url, text_to_speech
...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("call_logs.log"), logging.StreamHandler()],
)
...
async def process_voice_input(request: Request, background_tasks: BackgroundTasks):
    ...
    if order_update:
        if order_update.get("action") == "add":
            ...
            ai_response = (
                f"Your order has been confirmed! Your order number is {order_id}. "
